...
public class CustomOrderEffects : OpenRA.Mods.Common.Traits.INotifyOrderIssued
{
	...
	bool OpenRA.Mods.Common.Traits.INotifyOrderIssued.OrderIssued(OpenRA.World world, string orderString, Target target)
	{
