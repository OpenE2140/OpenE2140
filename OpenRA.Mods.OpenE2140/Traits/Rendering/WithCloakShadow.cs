...
public class WithCloakShadowInfo : TraitInfo, Requires<CloakInfo>
{
...
public class WithCloakShadow : IRenderModifier
{
	...
	IEnumerable<IRenderable> IRenderModifier.ModifyRender(Actor self, WorldRenderer wr, IEnumerable<IRenderable> renderables)
	{
		...
		return self.TraitsImplementing<RenderSprites>()
			.SelectMany(rs => rs.Render(self, wr))
